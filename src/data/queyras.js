...
export const ETAPES = [
  {
    ...
    chiffres: [
      { valeur: "4h", libelle: "Marche" },
      { valeur: "+510 m", libelle: "D+" },
      { valeur: "-660 m", libelle: "D-" },
    ],
  ...
  },
  {
    ...
    chiffres: [
      { valeur: "5h", libelle: "Marche" },
      { valeur: "+820 m", libelle: "D+" },
      { valeur: "-210 m", libelle: "D-" },
    ],
  ...
  },
  {
    ...
    chiffres: [
      { valeur: "4h30", libelle: "Marche" },
      { valeur: "+210 m", libelle: "D+" },
      { valeur: "-1000 m", libelle: "D-" },
    ],
